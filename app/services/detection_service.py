...
class ObjectDetectionService:
    def __init__(self, video_path, model_path="../yolov8n.pt"):
        ...
        self.output_video_path = os.path.join(self.output_dir, f"{self.detection_output_id}_out.mp4")
        self.out = cv2.VideoWriter(self.output_video_path, cv2.VideoWriter_fourcc(*'H264'), self.fps,
                                   (self.frame_width, self.frame_height))
        # self.out = cv2.VideoWriter(self.output_video_path, cv2.VideoWriter_fourcc(*'AVC1'), self.fps,
        #                            (self.frame_width, self.frame_height))
        self.final_output_video_path = os.path.join(self.output_dir, f"{self.detection_output_id}_final_output.mp4")
